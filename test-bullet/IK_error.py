...
ll = [-.967, -2, -2.96, -2.09, -2.96, -2.09, -3.05]
...
#jointPoses = p.calculateInverseKinematics(kukaId, kukaEndEffectorIndex, pos, lowerLimits=ll, upperLimits=ul, jointRanges=jr)
...
for i in range(p.getNumJoints(kukaId)):
    print("joint info", i, "=",  p.getJointInfo(kukaId, i))
