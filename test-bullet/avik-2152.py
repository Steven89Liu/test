...
bid2 = p.loadURDF("TwoJointRobot.urdf", startPos2,	startOrientation,	useFixedBase=True)
bid	=	p.loadURDF("TwoJointRobot.urdf",	startPos,	startOrientation,	useFixedBase=True)
