...
def runSim():
    ...
    url = 'https://gist.githubusercontent.com/seann999/4c90f837e42b2964b470fc9028e89bc1/raw/67fccf6d2d4b39a652756a0f4e385a68cc648935/bot.xml'
    r = requests.get(url)
    open('mmbot.xml', 'wb').write(r.content)

    path = os.path.abspath(os.path.dirname(__file__))
    botId = p.loadURDF(os.path.join(path, "mmbot.xml"),
                      [0, 0, 0.001],
